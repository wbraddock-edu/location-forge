...
export const ART_STYLES = [
  { id: "cinematic", name: "Cinematic Concept Art", prompt: "STRICT STYLE LOCK: cinematic concept art. Every image MUST use the same semi-realistic digital painting style with dramatic cinematic lighting, visible brushwork, rich color grading, and film-production quality. Do NOT switch to photorealistic rendering or flat illustration for any image. Maintain this exact rendering approach regardless of subject matter — close-ups, full body, and environments all use the same painterly cinematic look" },
  { id: "photorealistic", name: "Photorealistic", prompt: "STRICT STYLE LOCK: photorealistic. Every image MUST look like a real photograph — hyperrealistic skin textures, real-world lighting, studio photography quality, shallow depth of field, 8K detail. Do NOT switch to illustrated, painted, or stylized rendering for any image. Turnarounds, expressions, poses, and close-ups must ALL look like real photographs of the same person" },
  { id: "pixar", name: "Pixar / 3D Animation", prompt: "STRICT STYLE LOCK: Pixar 3D animation style. Every image MUST look like a Pixar/Disney 3D rendered frame — smooth subsurface scattering skin, soft rounded features, slightly exaggerated proportions, warm global illumination. Do NOT mix in photorealistic or 2D styles. All images must look like they came from the same animated film" },
  { id: "anime", name: "Anime / Manga", prompt: "STRICT STYLE LOCK: anime art style. Every image MUST use consistent anime/manga rendering — clean sharp linework, cel-shaded flat coloring with subtle gradients, large expressive eyes, Japanese animation production quality. Do NOT switch to realistic or Western illustration style for any image. Turnarounds, close-ups, and scenes all use the same anime look" },
  { id: "3d-render", name: "3D Render / Game Art", prompt: "STRICT STYLE LOCK: 3D game character render. Every image MUST look like Unreal Engine 5 real-time rendering — PBR materials, subsurface scattering, volumetric lighting, AAA game quality. Do NOT switch to 2D illustration or painterly styles. All images look like in-engine screenshots from the same game" },
  { id: "2d-illustration", name: "2D Illustration", prompt: "STRICT STYLE LOCK: 2D digital illustration. Every image MUST use clean vector-like linework with flat color and subtle cel-shading — modern character design sheet aesthetic, graphic novel quality. Do NOT switch to photorealistic or 3D rendering for any image. Close-ups, full body, and environments all use the same flat illustrated look" },
  { id: "comic-book", name: "Comic Book", prompt: "STRICT STYLE LOCK: comic book art. Every image MUST use bold ink outlines, dynamic hatching and crosshatching, vivid saturated colors, comic book art composition. Do NOT switch to photorealistic or soft painted styles. All images look like pages from the same comic book" },
